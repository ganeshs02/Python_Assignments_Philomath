"""Read product file and tran_dtl file and implement inner join using loops
...
for p_id in product_dict:
    if p_id in tran_dtl_dict:
        for tran in tran_dtl_dict[p_id]:
            line = product_dict[p_id] + tran
